	...
	return (
		...
		>
			...
			<p className="text-gray-700">
				Partido:{" "}
				<a
					href={profileData.uriPartido}
					className="text-blue-500 hover:underline"
				>
					{profileData.siglaPartido}
				</a>
			</p>
        ...
        Email: <a href={`mailto:${profileData.email}`} className="text-blue-500 hover:underline">{profileData.email}</a>
			...
			<a href={profileData.uri} className="text-blue-500 hover:underline">
				More Info
			</a>
		</div>
	);
